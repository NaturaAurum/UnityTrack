...
public class EnemyGenerator : MonoBehaviour
{
    ...
    private void GenerateEnemy()
    {
        ...
        // Random.Range에는 min값과 max 값을 넘겨줘야하는데
        // Random.Range를 통해서 나오는 값은 min <= value < max
        Transform generetePoint = generatePoints[Random.Range(0, generatePoints.Length)];
        // 랜덤으로 얻어온 point에 생성
        Instantiate(EnemyPrefab, generetePoint.position, Quaternion.Euler(90, 0, 180));
    }
